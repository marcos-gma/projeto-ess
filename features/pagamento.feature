...
Scenario: Visualizar métodos de pagamento
	...
	Then eu visualizo a lista de métodos de pagamento
	registrados
...
Scenario: Visualizar métodos de pagamento quando existem
	...
	When uma nova requisição GET é feita para o endpoint
	“/metodos_de_pagamento”
	Then o sistema retorna o cartão com card_number “5555
	5555 5555 5555” e type “debit”
...
Scenario: Visualizar métodos de pagamento quando não existem
	...
	When uma nova requisição GET é feita para o endpoint
	“/metodos_de_pagamento”
	Then o código de resposta é “404”

Scenario: Adicionar novo método de pagamento com sucesso
	Given o usuário com e-mail “iasmin@protonmail.com” está
	cadastrado no sistema
	And não há o cartão com card_number “5555 5555 5555
	5555” e type “debit” registrado no seu cadastro
	When uma nova requisição POST é feita para o endpoint
	“/metodos_de_pagamento” com o body: card_number: “5555
	5555 5555 5555”, name: “Iasmin Gomes”, expire_date:
	“06/2100”, type: “debit” e cvv: “123”
	Then o cartão com card_number “5555 5555 5555
	5555” e type “debit” é registrado no seu cadastro
...
Scenario: Remover método de pagamento
	...
	And o cartão com card_number “5555 5555 5555
	5555” e type “debit” está registrado no seu cadastro
	When uma nova requisição DELETE é feita para o endpoint
	“\metodos_de_pagamento”
