  ...
  Para que eu possa gerenciar as reservas
    ...
    GUI:
        ...
        Scenario: Ver lista de reservas confirmadas na acomodação via GUI
            ...
            When eu clico no botão "Listar Reservas" para a acomodação com ID "1"
            Then eu devo ver uma lista de reservas confirmadas para a acomodação com ID "1"
    ...
    SERVICE:
        Scenario: Ver lista de reservas confirmadas na acomodação via Serviço
            Given que eu tenha o ID do usuário "123" e o ID da acomodação "1"
            When eu envio uma requisição GET para "/user/host/minhas_acom/?userId=123&acomId=1"
            Then a resposta deve ter o status "200 OK"
            And a resposta deve conter uma lista de reservas confirmadas para a acomodação com ID "1"
