...
Feature: Busca com Filtros
    ...
    Scenario: Busca Básica no Servidor
        ...
        And o destino como “Fernando de Noronha”
        And a quantidade de pessoas como “2”
        When “Guilherme” envia uma requisição com essas informações
        Then os hotéis “Pousada Maresia” e “Moradia do Mar" são enviados do servidor para o cliente
        When “Guilherme” clica no filtro de faixa de preço e coloca “3.000” como valor limite
        And seleciona a opção de filtro Pet Friendly
        And “Guilherme” envia uma requisição com essas informações
        Then apenas a “Pousada Maresia” é enviada para "“Guilherme”