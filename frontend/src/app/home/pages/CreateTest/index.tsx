...
const CreateTest = () => {
  ...
  useEffect(() => {
    if (state.createTestRequestStatus !== prevState?.createTestRequestStatus && state.createTestRequestStatus.isSuccess()) {
    ...
    <section className={styles.container}>
      ...
      <form className={styles.formContainer} onSubmit={handleSubmit(onSubmit)}>
        <div className={styles.formInputContainer}>
          <input data-cy='input-name' {...register('name')} placeholder='Digite o nome' className={styles.formInput} />
          {errors.name && (
