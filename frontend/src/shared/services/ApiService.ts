...
export class ApiService {
  ...
  public async get(path: string, queryParams?: any): Promise<Result<BaseApiResponseModel>> {
    try {
  ...
  public async post(path: string, body: any): Promise<Result<BaseApiResponseModel>> {
    try {
  ...
  public async update(path: string, body: any): Promise<Result<BaseApiResponseModel>> {
    try {
  ...
  public async delete(path: string, queryParams?: any): Promise<Result<BaseApiResponseModel>> {
    try {
